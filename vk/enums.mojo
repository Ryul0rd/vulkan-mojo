...
struct ImageLayout(Equatable):
    ...
    comptime DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR = ImageLayout(value = 1000117000)
    comptime DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL = ImageLayout(value = 1000117001)
    comptime DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR = ImageLayout(value = 1000117001)
    comptime FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR = ImageLayout(value = 1000164003)
    comptime SHADING_RATE_OPTIMAL_NV = ImageLayout(value = 1000164003)
    ...
    comptime RENDERING_LOCAL_READ_KHR = ImageLayout(value = 1000232000)
    comptime DEPTH_ATTACHMENT_OPTIMAL = ImageLayout(value = 1000241000)
    comptime DEPTH_ATTACHMENT_OPTIMAL_KHR = ImageLayout(value = 1000241000)
    comptime DEPTH_READ_ONLY_OPTIMAL = ImageLayout(value = 1000241001)
    comptime DEPTH_READ_ONLY_OPTIMAL_KHR = ImageLayout(value = 1000241001)
    comptime STENCIL_ATTACHMENT_OPTIMAL = ImageLayout(value = 1000241002)
    comptime STENCIL_ATTACHMENT_OPTIMAL_KHR = ImageLayout(value = 1000241002)
    comptime STENCIL_READ_ONLY_OPTIMAL = ImageLayout(value = 1000241003)
    comptime STENCIL_READ_ONLY_OPTIMAL_KHR = ImageLayout(value = 1000241003)
    ...
    comptime READ_ONLY_OPTIMAL_KHR = ImageLayout(value = 1000314000)
    comptime ATTACHMENT_OPTIMAL = ImageLayout(value = 1000314001)
    comptime ATTACHMENT_OPTIMAL_KHR = ImageLayout(value = 1000314001)
...
struct AttachmentLoadOp(Equatable):
    ...
    comptime NONE_EXT = AttachmentLoadOp(value = 1000400000)
    comptime NONE_KHR = AttachmentLoadOp(value = 1000400000)
...
struct AttachmentStoreOp(Equatable):
    ...
    comptime NONE_EXT = AttachmentStoreOp(value = 1000301000)
    comptime NONE_KHR = AttachmentStoreOp(value = 1000301000)
    comptime NONE_QCOM = AttachmentStoreOp(value = 1000301000)
...
struct DescriptorType(Equatable):
    ...
    comptime INLINE_UNIFORM_BLOCK_EXT = DescriptorType(value = 1000138000)
    ...
    comptime MUTABLE_VALVE = DescriptorType(value = 1000351000)
...
struct PipelineBindPoint(Equatable):
    ...
    comptime RAY_TRACING_NV = PipelineBindPoint(value = 1000165000)
...
struct IndexType(Equatable):
    ...
    comptime NONE_NV = IndexType(value = 1000165000)
    comptime UINT8 = IndexType(value = 1000265000)
    comptime UINT8_EXT = IndexType(value = 1000265000)
    comptime UINT8_KHR = IndexType(value = 1000265000)
...
struct Filter(Equatable):
    ...
    comptime CUBIC_IMG = Filter(value = 1000015000)
...
struct SamplerAddressMode(Equatable):
    ...
    comptime MIRROR_CLAMP_TO_EDGE_KHR = SamplerAddressMode(value = 4)
...
struct Format(Equatable):
    ...
    comptime ASTC_4x4_SFLOAT_BLOCK_EXT = Format(value = 1000066000)
    comptime ASTC_5x4_SFLOAT_BLOCK = Format(value = 1000066001)
    comptime ASTC_5x4_SFLOAT_BLOCK_EXT = Format(value = 1000066001)
    comptime ASTC_5x5_SFLOAT_BLOCK = Format(value = 1000066002)
    comptime ASTC_5x5_SFLOAT_BLOCK_EXT = Format(value = 1000066002)
    comptime ASTC_6x5_SFLOAT_BLOCK = Format(value = 1000066003)
    comptime ASTC_6x5_SFLOAT_BLOCK_EXT = Format(value = 1000066003)
    comptime ASTC_6x6_SFLOAT_BLOCK = Format(value = 1000066004)
    comptime ASTC_6x6_SFLOAT_BLOCK_EXT = Format(value = 1000066004)
    comptime ASTC_8x5_SFLOAT_BLOCK = Format(value = 1000066005)
    comptime ASTC_8x5_SFLOAT_BLOCK_EXT = Format(value = 1000066005)
    comptime ASTC_8x6_SFLOAT_BLOCK = Format(value = 1000066006)
    comptime ASTC_8x6_SFLOAT_BLOCK_EXT = Format(value = 1000066006)
    comptime ASTC_8x8_SFLOAT_BLOCK = Format(value = 1000066007)
    comptime ASTC_8x8_SFLOAT_BLOCK_EXT = Format(value = 1000066007)
    comptime ASTC_10x5_SFLOAT_BLOCK = Format(value = 1000066008)
    comptime ASTC_10x5_SFLOAT_BLOCK_EXT = Format(value = 1000066008)
    comptime ASTC_10x6_SFLOAT_BLOCK = Format(value = 1000066009)
    comptime ASTC_10x6_SFLOAT_BLOCK_EXT = Format(value = 1000066009)
    comptime ASTC_10x8_SFLOAT_BLOCK = Format(value = 1000066010)
    comptime ASTC_10x8_SFLOAT_BLOCK_EXT = Format(value = 1000066010)
    comptime ASTC_10x10_SFLOAT_BLOCK = Format(value = 1000066011)
    comptime ASTC_10x10_SFLOAT_BLOCK_EXT = Format(value = 1000066011)
    comptime ASTC_12x10_SFLOAT_BLOCK = Format(value = 1000066012)
    comptime ASTC_12x10_SFLOAT_BLOCK_EXT = Format(value = 1000066012)
    comptime ASTC_12x12_SFLOAT_BLOCK = Format(value = 1000066013)
    comptime ASTC_12x12_SFLOAT_BLOCK_EXT = Format(value = 1000066013)
    comptime G8B8G8R8_422_UNORM = Format(value = 1000156000)
    comptime G8B8G8R8_422_UNORM_KHR = Format(value = 1000156000)
    comptime B8G8R8G8_422_UNORM = Format(value = 1000156001)
    comptime B8G8R8G8_422_UNORM_KHR = Format(value = 1000156001)
    comptime G8_B8_R8_3PLANE_420_UNORM = Format(value = 1000156002)
    comptime G8_B8_R8_3PLANE_420_UNORM_KHR = Format(value = 1000156002)
    comptime G8_B8R8_2PLANE_420_UNORM = Format(value = 1000156003)
    comptime G8_B8R8_2PLANE_420_UNORM_KHR = Format(value = 1000156003)
    comptime G8_B8_R8_3PLANE_422_UNORM = Format(value = 1000156004)
    comptime G8_B8_R8_3PLANE_422_UNORM_KHR = Format(value = 1000156004)
    comptime G8_B8R8_2PLANE_422_UNORM = Format(value = 1000156005)
    comptime G8_B8R8_2PLANE_422_UNORM_KHR = Format(value = 1000156005)
    comptime G8_B8_R8_3PLANE_444_UNORM = Format(value = 1000156006)
    comptime G8_B8_R8_3PLANE_444_UNORM_KHR = Format(value = 1000156006)
    comptime R10X6_UNORM_PACK16 = Format(value = 1000156007)
    comptime R10X6_UNORM_PACK16_KHR = Format(value = 1000156007)
    comptime R10X6G10X6_UNORM_2PACK16 = Format(value = 1000156008)
    comptime R10X6G10X6_UNORM_2PACK16_KHR = Format(value = 1000156008)
    comptime R10X6G10X6B10X6A10X6_UNORM_4PACK16 = Format(value = 1000156009)
    comptime R10X6G10X6B10X6A10X6_UNORM_4PACK16_KHR = Format(value = 1000156009)
    comptime G10X6B10X6G10X6R10X6_422_UNORM_4PACK16 = Format(value = 1000156010)
    comptime G10X6B10X6G10X6R10X6_422_UNORM_4PACK16_KHR = Format(value = 1000156010)
    comptime B10X6G10X6R10X6G10X6_422_UNORM_4PACK16 = Format(value = 1000156011)
    comptime B10X6G10X6R10X6G10X6_422_UNORM_4PACK16_KHR = Format(value = 1000156011)
    comptime G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16 = Format(value = 1000156012)
    comptime G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16_KHR = Format(value = 1000156012)
    comptime G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16 = Format(value = 1000156013)
    comptime G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16_KHR = Format(value = 1000156013)
    comptime G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16 = Format(value = 1000156014)
    comptime G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16_KHR = Format(value = 1000156014)
    comptime G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16 = Format(value = 1000156015)
    comptime G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16_KHR = Format(value = 1000156015)
    comptime G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16 = Format(value = 1000156016)
    comptime G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16_KHR = Format(value = 1000156016)
    comptime R12X4_UNORM_PACK16 = Format(value = 1000156017)
    comptime R12X4_UNORM_PACK16_KHR = Format(value = 1000156017)
    comptime R12X4G12X4_UNORM_2PACK16 = Format(value = 1000156018)
    comptime R12X4G12X4_UNORM_2PACK16_KHR = Format(value = 1000156018)
    comptime R12X4G12X4B12X4A12X4_UNORM_4PACK16 = Format(value = 1000156019)
    comptime R12X4G12X4B12X4A12X4_UNORM_4PACK16_KHR = Format(value = 1000156019)
    comptime G12X4B12X4G12X4R12X4_422_UNORM_4PACK16 = Format(value = 1000156020)
    comptime G12X4B12X4G12X4R12X4_422_UNORM_4PACK16_KHR = Format(value = 1000156020)
    comptime B12X4G12X4R12X4G12X4_422_UNORM_4PACK16 = Format(value = 1000156021)
    comptime B12X4G12X4R12X4G12X4_422_UNORM_4PACK16_KHR = Format(value = 1000156021)
    comptime G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16 = Format(value = 1000156022)
    comptime G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16_KHR = Format(value = 1000156022)
    comptime G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16 = Format(value = 1000156023)
    comptime G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16_KHR = Format(value = 1000156023)
    comptime G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16 = Format(value = 1000156024)
    comptime G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16_KHR = Format(value = 1000156024)
    comptime G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16 = Format(value = 1000156025)
    comptime G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16_KHR = Format(value = 1000156025)
    comptime G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16 = Format(value = 1000156026)
    comptime G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16_KHR = Format(value = 1000156026)
    comptime G16B16G16R16_422_UNORM = Format(value = 1000156027)
    comptime G16B16G16R16_422_UNORM_KHR = Format(value = 1000156027)
    comptime B16G16R16G16_422_UNORM = Format(value = 1000156028)
    comptime B16G16R16G16_422_UNORM_KHR = Format(value = 1000156028)
    comptime G16_B16_R16_3PLANE_420_UNORM = Format(value = 1000156029)
    comptime G16_B16_R16_3PLANE_420_UNORM_KHR = Format(value = 1000156029)
    comptime G16_B16R16_2PLANE_420_UNORM = Format(value = 1000156030)
    comptime G16_B16R16_2PLANE_420_UNORM_KHR = Format(value = 1000156030)
    comptime G16_B16_R16_3PLANE_422_UNORM = Format(value = 1000156031)
    comptime G16_B16_R16_3PLANE_422_UNORM_KHR = Format(value = 1000156031)
    comptime G16_B16R16_2PLANE_422_UNORM = Format(value = 1000156032)
    comptime G16_B16R16_2PLANE_422_UNORM_KHR = Format(value = 1000156032)
    comptime G16_B16_R16_3PLANE_444_UNORM = Format(value = 1000156033)
    comptime G16_B16_R16_3PLANE_444_UNORM_KHR = Format(value = 1000156033)
    ...
    comptime G8_B8R8_2PLANE_444_UNORM_EXT = Format(value = 1000330000)
    comptime G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16 = Format(value = 1000330001)
    comptime G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT = Format(value = 1000330001)
    comptime G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16 = Format(value = 1000330002)
    comptime G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT = Format(value = 1000330002)
    comptime G16_B16R16_2PLANE_444_UNORM = Format(value = 1000330003)
    comptime G16_B16R16_2PLANE_444_UNORM_EXT = Format(value = 1000330003)
    comptime A4R4G4B4_UNORM_PACK16 = Format(value = 1000340000)
    comptime A4R4G4B4_UNORM_PACK16_EXT = Format(value = 1000340000)
    comptime A4B4G4R4_UNORM_PACK16 = Format(value = 1000340001)
    comptime A4B4G4R4_UNORM_PACK16_EXT = Format(value = 1000340001)
    comptime R8_BOOL_ARM = Format(value = 1000460000)
    comptime R16G16_S10_5_NV = Format(value = 1000464000)
    comptime R16G16_SFIXED5_NV = Format(value = 1000464000)
    comptime A1B5G5R5_UNORM_PACK16 = Format(value = 1000470000)
    comptime A1B5G5R5_UNORM_PACK16_KHR = Format(value = 1000470000)
    comptime A8_UNORM = Format(value = 1000470001)
    comptime A8_UNORM_KHR = Format(value = 1000470001)
...
struct StructureType(Equatable):
    ...
    comptime DEBUG_REPORT_CREATE_INFO_EXT = StructureType(value = 1000011000)
    ...
    comptime RENDERING_INFO_KHR = StructureType(value = 1000044000)
    comptime RENDERING_ATTACHMENT_INFO = StructureType(value = 1000044001)
    comptime RENDERING_ATTACHMENT_INFO_KHR = StructureType(value = 1000044001)
    comptime PIPELINE_RENDERING_CREATE_INFO = StructureType(value = 1000044002)
    comptime PIPELINE_RENDERING_CREATE_INFO_KHR = StructureType(value = 1000044002)
    comptime PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES = StructureType(value = 1000044003)
    comptime PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES_KHR = StructureType(value = 1000044003)
    comptime COMMAND_BUFFER_INHERITANCE_RENDERING_INFO = StructureType(value = 1000044004)
    comptime COMMAND_BUFFER_INHERITANCE_RENDERING_INFO_KHR = StructureType(value = 1000044004)
    ...
    comptime ATTACHMENT_SAMPLE_COUNT_INFO_NV = StructureType(value = 1000044008)
    ...
    comptime RENDER_PASS_MULTIVIEW_CREATE_INFO_KHR = StructureType(value = 1000053000)
    comptime PHYSICAL_DEVICE_MULTIVIEW_FEATURES = StructureType(value = 1000053001)
    comptime PHYSICAL_DEVICE_MULTIVIEW_FEATURES_KHR = StructureType(value = 1000053001)
    comptime PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES = StructureType(value = 1000053002)
    comptime PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES_KHR = StructureType(value = 1000053002)
    ...
    comptime PHYSICAL_DEVICE_FEATURES_2_KHR = StructureType(value = 1000059000)
    comptime PHYSICAL_DEVICE_PROPERTIES_2 = StructureType(value = 1000059001)
    comptime PHYSICAL_DEVICE_PROPERTIES_2_KHR = StructureType(value = 1000059001)
    comptime FORMAT_PROPERTIES_2 = StructureType(value = 1000059002)
    comptime FORMAT_PROPERTIES_2_KHR = StructureType(value = 1000059002)
    comptime IMAGE_FORMAT_PROPERTIES_2 = StructureType(value = 1000059003)
    comptime IMAGE_FORMAT_PROPERTIES_2_KHR = StructureType(value = 1000059003)
    comptime PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2 = StructureType(value = 1000059004)
    comptime PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2_KHR = StructureType(value = 1000059004)
    comptime QUEUE_FAMILY_PROPERTIES_2 = StructureType(value = 1000059005)
    comptime QUEUE_FAMILY_PROPERTIES_2_KHR = StructureType(value = 1000059005)
    comptime PHYSICAL_DEVICE_MEMORY_PROPERTIES_2 = StructureType(value = 1000059006)
    comptime PHYSICAL_DEVICE_MEMORY_PROPERTIES_2_KHR = StructureType(value = 1000059006)
    comptime SPARSE_IMAGE_FORMAT_PROPERTIES_2 = StructureType(value = 1000059007)
    comptime SPARSE_IMAGE_FORMAT_PROPERTIES_2_KHR = StructureType(value = 1000059007)
    comptime PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2 = StructureType(value = 1000059008)
    comptime PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2_KHR = StructureType(value = 1000059008)
    comptime MEMORY_ALLOCATE_FLAGS_INFO = StructureType(value = 1000060000)
    comptime MEMORY_ALLOCATE_FLAGS_INFO_KHR = StructureType(value = 1000060000)
    comptime DEVICE_GROUP_RENDER_PASS_BEGIN_INFO = StructureType(value = 1000060003)
    comptime DEVICE_GROUP_RENDER_PASS_BEGIN_INFO_KHR = StructureType(value = 1000060003)
    comptime DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO = StructureType(value = 1000060004)
    comptime DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO_KHR = StructureType(value = 1000060004)
    comptime DEVICE_GROUP_SUBMIT_INFO = StructureType(value = 1000060005)
    comptime DEVICE_GROUP_SUBMIT_INFO_KHR = StructureType(value = 1000060005)
    comptime DEVICE_GROUP_BIND_SPARSE_INFO = StructureType(value = 1000060006)
    comptime DEVICE_GROUP_BIND_SPARSE_INFO_KHR = StructureType(value = 1000060006)
    ...
    comptime BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO_KHR = StructureType(value = 1000060013)
    comptime BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO = StructureType(value = 1000060014)
    comptime BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO_KHR = StructureType(value = 1000060014)
    ...
    comptime PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES_EXT = StructureType(value = 1000066000)
    ...
    comptime PIPELINE_ROBUSTNESS_CREATE_INFO_EXT = StructureType(value = 1000068000)
    comptime PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES = StructureType(value = 1000068001)
    comptime PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES_EXT = StructureType(value = 1000068001)
    comptime PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES = StructureType(value = 1000068002)
    comptime PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES_EXT = StructureType(value = 1000068002)
    comptime PHYSICAL_DEVICE_GROUP_PROPERTIES = StructureType(value = 1000070000)
    comptime PHYSICAL_DEVICE_GROUP_PROPERTIES_KHR = StructureType(value = 1000070000)
    comptime DEVICE_GROUP_DEVICE_CREATE_INFO = StructureType(value = 1000070001)
    comptime DEVICE_GROUP_DEVICE_CREATE_INFO_KHR = StructureType(value = 1000070001)
    comptime PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO = StructureType(value = 1000071000)
    comptime PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO_KHR = StructureType(value = 1000071000)
    comptime EXTERNAL_IMAGE_FORMAT_PROPERTIES = StructureType(value = 1000071001)
    comptime EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHR = StructureType(value = 1000071001)
    comptime PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO = StructureType(value = 1000071002)
    comptime PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO_KHR = StructureType(value = 1000071002)
    comptime EXTERNAL_BUFFER_PROPERTIES = StructureType(value = 1000071003)
    comptime EXTERNAL_BUFFER_PROPERTIES_KHR = StructureType(value = 1000071003)
    comptime PHYSICAL_DEVICE_ID_PROPERTIES = StructureType(value = 1000071004)
    comptime PHYSICAL_DEVICE_ID_PROPERTIES_KHR = StructureType(value = 1000071004)
    comptime EXTERNAL_MEMORY_BUFFER_CREATE_INFO = StructureType(value = 1000072000)
    comptime EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHR = StructureType(value = 1000072000)
    comptime EXTERNAL_MEMORY_IMAGE_CREATE_INFO = StructureType(value = 1000072001)
    comptime EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHR = StructureType(value = 1000072001)
    comptime EXPORT_MEMORY_ALLOCATE_INFO = StructureType(value = 1000072002)
    comptime EXPORT_MEMORY_ALLOCATE_INFO_KHR = StructureType(value = 1000072002)
    ...
    comptime PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHR = StructureType(value = 1000076000)
    comptime EXTERNAL_SEMAPHORE_PROPERTIES = StructureType(value = 1000076001)
    comptime EXTERNAL_SEMAPHORE_PROPERTIES_KHR = StructureType(value = 1000076001)
    comptime EXPORT_SEMAPHORE_CREATE_INFO = StructureType(value = 1000077000)
    comptime EXPORT_SEMAPHORE_CREATE_INFO_KHR = StructureType(value = 1000077000)
    ...
    comptime PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR = StructureType(value = 1000080000)
    ...
    comptime PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR = StructureType(value = 1000082000)
    comptime PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES = StructureType(value = 1000082000)
    comptime PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES_KHR = StructureType(value = 1000082000)
    comptime PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES = StructureType(value = 1000083000)
    comptime PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES_KHR = StructureType(value = 1000083000)
    ...
    comptime DESCRIPTOR_UPDATE_TEMPLATE_CREATE_INFO_KHR = StructureType(value = 1000085000)
    comptime PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV = StructureType(value = 1000087000)
    comptime SURFACE_CAPABILITIES2_EXT = StructureType(value = 1000090000)
    ...
    comptime PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES_KHR = StructureType(value = 1000108000)
    comptime FRAMEBUFFER_ATTACHMENTS_CREATE_INFO = StructureType(value = 1000108001)
    comptime FRAMEBUFFER_ATTACHMENTS_CREATE_INFO_KHR = StructureType(value = 1000108001)
    comptime FRAMEBUFFER_ATTACHMENT_IMAGE_INFO = StructureType(value = 1000108002)
    comptime FRAMEBUFFER_ATTACHMENT_IMAGE_INFO_KHR = StructureType(value = 1000108002)
    comptime RENDER_PASS_ATTACHMENT_BEGIN_INFO = StructureType(value = 1000108003)
    comptime RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR = StructureType(value = 1000108003)
    comptime ATTACHMENT_DESCRIPTION_2 = StructureType(value = 1000109000)
    comptime ATTACHMENT_DESCRIPTION_2_KHR = StructureType(value = 1000109000)
    comptime ATTACHMENT_REFERENCE_2 = StructureType(value = 1000109001)
    comptime ATTACHMENT_REFERENCE_2_KHR = StructureType(value = 1000109001)
    comptime SUBPASS_DESCRIPTION_2 = StructureType(value = 1000109002)
    comptime SUBPASS_DESCRIPTION_2_KHR = StructureType(value = 1000109002)
    comptime SUBPASS_DEPENDENCY_2 = StructureType(value = 1000109003)
    comptime SUBPASS_DEPENDENCY_2_KHR = StructureType(value = 1000109003)
    comptime RENDER_PASS_CREATE_INFO_2 = StructureType(value = 1000109004)
    comptime RENDER_PASS_CREATE_INFO_2_KHR = StructureType(value = 1000109004)
    comptime SUBPASS_BEGIN_INFO = StructureType(value = 1000109005)
    comptime SUBPASS_BEGIN_INFO_KHR = StructureType(value = 1000109005)
    comptime SUBPASS_END_INFO = StructureType(value = 1000109006)
    comptime SUBPASS_END_INFO_KHR = StructureType(value = 1000109006)
    ...
    comptime PHYSICAL_DEVICE_EXTERNAL_FENCE_INFO_KHR = StructureType(value = 1000112000)
    comptime EXTERNAL_FENCE_PROPERTIES = StructureType(value = 1000112001)
    comptime EXTERNAL_FENCE_PROPERTIES_KHR = StructureType(value = 1000112001)
    comptime EXPORT_FENCE_CREATE_INFO = StructureType(value = 1000113000)
    comptime EXPORT_FENCE_CREATE_INFO_KHR = StructureType(value = 1000113000)
    ...
    comptime PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES_KHR = StructureType(value = 1000117000)
    comptime RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO = StructureType(value = 1000117001)
    comptime RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO_KHR = StructureType(value = 1000117001)
    comptime IMAGE_VIEW_USAGE_CREATE_INFO = StructureType(value = 1000117002)
    comptime IMAGE_VIEW_USAGE_CREATE_INFO_KHR = StructureType(value = 1000117002)
    comptime PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO = StructureType(value = 1000117003)
    comptime PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO_KHR = StructureType(value = 1000117003)
    ...
    comptime PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES_KHR = StructureType(value = 1000120000)
    comptime PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES = StructureType(value = 1000120000)
    comptime PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES_KHR = StructureType(value = 1000120000)
    ...
    comptime MEMORY_DEDICATED_REQUIREMENTS_KHR = StructureType(value = 1000127000)
    comptime MEMORY_DEDICATED_ALLOCATE_INFO = StructureType(value = 1000127001)
    comptime MEMORY_DEDICATED_ALLOCATE_INFO_KHR = StructureType(value = 1000127001)
    ...
    comptime PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT = StructureType(value = 1000130000)
    comptime SAMPLER_REDUCTION_MODE_CREATE_INFO = StructureType(value = 1000130001)
    comptime SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT = StructureType(value = 1000130001)
    ...
    comptime PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT = StructureType(value = 1000138000)
    comptime PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES = StructureType(value = 1000138001)
    comptime PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT = StructureType(value = 1000138001)
    comptime WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK = StructureType(value = 1000138002)
    comptime WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT = StructureType(value = 1000138002)
    comptime DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO = StructureType(value = 1000138003)
    comptime DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT = StructureType(value = 1000138003)
    ...
    comptime BUFFER_MEMORY_REQUIREMENTS_INFO_2_KHR = StructureType(value = 1000146000)
    comptime IMAGE_MEMORY_REQUIREMENTS_INFO_2 = StructureType(value = 1000146001)
    comptime IMAGE_MEMORY_REQUIREMENTS_INFO_2_KHR = StructureType(value = 1000146001)
    comptime IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2 = StructureType(value = 1000146002)
    comptime IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2_KHR = StructureType(value = 1000146002)
    comptime MEMORY_REQUIREMENTS_2 = StructureType(value = 1000146003)
    comptime MEMORY_REQUIREMENTS_2_KHR = StructureType(value = 1000146003)
    comptime SPARSE_IMAGE_MEMORY_REQUIREMENTS_2 = StructureType(value = 1000146004)
    comptime SPARSE_IMAGE_MEMORY_REQUIREMENTS_2_KHR = StructureType(value = 1000146004)
    comptime IMAGE_FORMAT_LIST_CREATE_INFO = StructureType(value = 1000147000)
    comptime IMAGE_FORMAT_LIST_CREATE_INFO_KHR = StructureType(value = 1000147000)
    ...
    comptime SAMPLER_YCBCR_CONVERSION_CREATE_INFO_KHR = StructureType(value = 1000156000)
    comptime SAMPLER_YCBCR_CONVERSION_INFO = StructureType(value = 1000156001)
    comptime SAMPLER_YCBCR_CONVERSION_INFO_KHR = StructureType(value = 1000156001)
    comptime BIND_IMAGE_PLANE_MEMORY_INFO = StructureType(value = 1000156002)
    comptime BIND_IMAGE_PLANE_MEMORY_INFO_KHR = StructureType(value = 1000156002)
    comptime IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO = StructureType(value = 1000156003)
    comptime IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO_KHR = StructureType(value = 1000156003)
    comptime PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES = StructureType(value = 1000156004)
    comptime PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES_KHR = StructureType(value = 1000156004)
    comptime SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES = StructureType(value = 1000156005)
    comptime SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES_KHR = StructureType(value = 1000156005)
    comptime BIND_BUFFER_MEMORY_INFO = StructureType(value = 1000157000)
    comptime BIND_BUFFER_MEMORY_INFO_KHR = StructureType(value = 1000157000)
    comptime BIND_IMAGE_MEMORY_INFO = StructureType(value = 1000157001)
    comptime BIND_IMAGE_MEMORY_INFO_KHR = StructureType(value = 1000157001)
    ...
    comptime DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT = StructureType(value = 1000161000)
    comptime PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES = StructureType(value = 1000161001)
    comptime PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT = StructureType(value = 1000161001)
    comptime PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES = StructureType(value = 1000161002)
    comptime PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT = StructureType(value = 1000161002)
    comptime DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO = StructureType(value = 1000161003)
    comptime DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT = StructureType(value = 1000161003)
    comptime DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT = StructureType(value = 1000161004)
    comptime DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT = StructureType(value = 1000161004)
    ...
    comptime PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES_KHR = StructureType(value = 1000168000)
    comptime DESCRIPTOR_SET_LAYOUT_SUPPORT = StructureType(value = 1000168001)
    comptime DESCRIPTOR_SET_LAYOUT_SUPPORT_KHR = StructureType(value = 1000168001)
    ...
    comptime DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT = StructureType(value = 1000174000)
    comptime DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_KHR = StructureType(value = 1000174000)
    comptime PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES = StructureType(value = 1000175000)
    comptime PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR = StructureType(value = 1000175000)
    comptime PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES = StructureType(value = 1000177000)
    comptime PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR = StructureType(value = 1000177000)
    ...
    comptime PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES_KHR = StructureType(value = 1000180000)
    ...
    comptime CALIBRATED_TIMESTAMP_INFO_EXT = StructureType(value = 1000184000)
    ...
    comptime PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT = StructureType(value = 1000190001)
    comptime PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_KHR = StructureType(value = 1000190001)
    comptime PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES = StructureType(value = 1000190002)
    comptime PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT = StructureType(value = 1000190002)
    comptime PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR = StructureType(value = 1000190002)
    ...
    comptime PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT = StructureType(value = 1000192000)
    comptime PHYSICAL_DEVICE_DRIVER_PROPERTIES = StructureType(value = 1000196000)
    comptime PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR = StructureType(value = 1000196000)
    comptime PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES = StructureType(value = 1000197000)
    comptime PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR = StructureType(value = 1000197000)
    comptime PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES = StructureType(value = 1000199000)
    comptime PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR = StructureType(value = 1000199000)
    comptime SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE = StructureType(value = 1000199001)
    comptime SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR = StructureType(value = 1000199001)
    comptime PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR = StructureType(value = 1000201000)
    comptime PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV = StructureType(value = 1000201000)
    ...
    comptime PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV = StructureType(value = 1000203000)
    ...
    comptime PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR = StructureType(value = 1000207000)
    comptime PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES = StructureType(value = 1000207001)
    comptime PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR = StructureType(value = 1000207001)
    comptime SEMAPHORE_TYPE_CREATE_INFO = StructureType(value = 1000207002)
    comptime SEMAPHORE_TYPE_CREATE_INFO_KHR = StructureType(value = 1000207002)
    comptime TIMELINE_SEMAPHORE_SUBMIT_INFO = StructureType(value = 1000207003)
    comptime TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR = StructureType(value = 1000207003)
    comptime SEMAPHORE_WAIT_INFO = StructureType(value = 1000207004)
    comptime SEMAPHORE_WAIT_INFO_KHR = StructureType(value = 1000207004)
    comptime SEMAPHORE_SIGNAL_INFO = StructureType(value = 1000207005)
    comptime SEMAPHORE_SIGNAL_INFO_KHR = StructureType(value = 1000207005)
    comptime PHYSICAL_DEVICE_SHADER_INTEGER_FUNCTIONS_2_FEATURES_INTEL = StructureType(value = 1000209000)
    comptime QUERY_POOL_CREATE_INFO_INTEL = StructureType(value = 1000210000)
    ...
    comptime PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES_KHR = StructureType(value = 1000211000)
    ...
    comptime PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES_KHR = StructureType(value = 1000215000)
    ...
    comptime PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT = StructureType(value = 1000221000)
    comptime PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES = StructureType(value = 1000225000)
    comptime PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES_EXT = StructureType(value = 1000225000)
    comptime PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO = StructureType(value = 1000225001)
    comptime PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO_EXT = StructureType(value = 1000225001)
    comptime SHADER_REQUIRED_SUBGROUP_SIZE_CREATE_INFO_EXT = StructureType(value = 1000225001)
    comptime PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES = StructureType(value = 1000225002)
    comptime PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES_EXT = StructureType(value = 1000225002)
    ...
    comptime PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES_KHR = StructureType(value = 1000232000)
    comptime RENDERING_ATTACHMENT_LOCATION_INFO = StructureType(value = 1000232001)
    comptime RENDERING_ATTACHMENT_LOCATION_INFO_KHR = StructureType(value = 1000232001)
    comptime RENDERING_INPUT_ATTACHMENT_INDEX_INFO = StructureType(value = 1000232002)
    comptime RENDERING_INPUT_ATTACHMENT_INDEX_INFO_KHR = StructureType(value = 1000232002)
    ...
    comptime PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR = StructureType(value = 1000241000)
    comptime ATTACHMENT_REFERENCE_STENCIL_LAYOUT = StructureType(value = 1000241001)
    comptime ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR = StructureType(value = 1000241001)
    comptime ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT = StructureType(value = 1000241002)
    comptime ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR = StructureType(value = 1000241002)
    comptime PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT = StructureType(value = 1000244000)
    ...
    comptime BUFFER_DEVICE_ADDRESS_INFO_EXT = StructureType(value = 1000244001)
    comptime BUFFER_DEVICE_ADDRESS_INFO_KHR = StructureType(value = 1000244001)
    ...
    comptime PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT = StructureType(value = 1000245000)
    comptime IMAGE_STENCIL_USAGE_CREATE_INFO = StructureType(value = 1000246000)
    comptime IMAGE_STENCIL_USAGE_CREATE_INFO_EXT = StructureType(value = 1000246000)
    ...
    comptime PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES_KHR = StructureType(value = 1000253000)
    ...
    comptime PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR = StructureType(value = 1000257000)
    comptime BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO = StructureType(value = 1000257002)
    comptime BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR = StructureType(value = 1000257002)
    comptime MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO = StructureType(value = 1000257003)
    comptime MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR = StructureType(value = 1000257003)
    comptime DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO = StructureType(value = 1000257004)
    comptime DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR = StructureType(value = 1000257004)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES = StructureType(value = 1000259000)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT = StructureType(value = 1000259000)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_KHR = StructureType(value = 1000259000)
    comptime PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO = StructureType(value = 1000259001)
    comptime PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_EXT = StructureType(value = 1000259001)
    comptime PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_KHR = StructureType(value = 1000259001)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES = StructureType(value = 1000259002)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_EXT = StructureType(value = 1000259002)
    comptime PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_KHR = StructureType(value = 1000259002)
    ...
    comptime PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT = StructureType(value = 1000261000)
    comptime PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES = StructureType(value = 1000265000)
    comptime PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_EXT = StructureType(value = 1000265000)
    comptime PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_KHR = StructureType(value = 1000265000)
    ...
    comptime PIPELINE_INFO_EXT = StructureType(value = 1000269001)
    ...
    comptime PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES_EXT = StructureType(value = 1000270000)
    comptime PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES = StructureType(value = 1000270001)
    comptime PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES_EXT = StructureType(value = 1000270001)
    comptime MEMORY_TO_IMAGE_COPY = StructureType(value = 1000270002)
    comptime MEMORY_TO_IMAGE_COPY_EXT = StructureType(value = 1000270002)
    comptime IMAGE_TO_MEMORY_COPY = StructureType(value = 1000270003)
    comptime IMAGE_TO_MEMORY_COPY_EXT = StructureType(value = 1000270003)
    comptime COPY_IMAGE_TO_MEMORY_INFO = StructureType(value = 1000270004)
    comptime COPY_IMAGE_TO_MEMORY_INFO_EXT = StructureType(value = 1000270004)
    comptime COPY_MEMORY_TO_IMAGE_INFO = StructureType(value = 1000270005)
    comptime COPY_MEMORY_TO_IMAGE_INFO_EXT = StructureType(value = 1000270005)
    comptime HOST_IMAGE_LAYOUT_TRANSITION_INFO = StructureType(value = 1000270006)
    comptime HOST_IMAGE_LAYOUT_TRANSITION_INFO_EXT = StructureType(value = 1000270006)
    comptime COPY_IMAGE_TO_IMAGE_INFO = StructureType(value = 1000270007)
    comptime COPY_IMAGE_TO_IMAGE_INFO_EXT = StructureType(value = 1000270007)
    comptime SUBRESOURCE_HOST_MEMCPY_SIZE = StructureType(value = 1000270008)
    comptime SUBRESOURCE_HOST_MEMCPY_SIZE_EXT = StructureType(value = 1000270008)
    comptime HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY = StructureType(value = 1000270009)
    comptime HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY_EXT = StructureType(value = 1000270009)
    comptime MEMORY_MAP_INFO = StructureType(value = 1000271000)
    comptime MEMORY_MAP_INFO_KHR = StructureType(value = 1000271000)
    comptime MEMORY_UNMAP_INFO = StructureType(value = 1000271001)
    comptime MEMORY_UNMAP_INFO_KHR = StructureType(value = 1000271001)
    ...
    comptime SURFACE_PRESENT_MODE_EXT = StructureType(value = 1000274000)
    comptime SURFACE_PRESENT_MODE_KHR = StructureType(value = 1000274000)
    comptime SURFACE_PRESENT_SCALING_CAPABILITIES_EXT = StructureType(value = 1000274001)
    comptime SURFACE_PRESENT_SCALING_CAPABILITIES_KHR = StructureType(value = 1000274001)
    comptime SURFACE_PRESENT_MODE_COMPATIBILITY_EXT = StructureType(value = 1000274002)
    comptime SURFACE_PRESENT_MODE_COMPATIBILITY_KHR = StructureType(value = 1000274002)
    comptime PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_EXT = StructureType(value = 1000275000)
    comptime PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR = StructureType(value = 1000275000)
    comptime SWAPCHAIN_PRESENT_FENCE_INFO_EXT = StructureType(value = 1000275001)
    comptime SWAPCHAIN_PRESENT_FENCE_INFO_KHR = StructureType(value = 1000275001)
    comptime SWAPCHAIN_PRESENT_MODES_CREATE_INFO_EXT = StructureType(value = 1000275002)
    comptime SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR = StructureType(value = 1000275002)
    comptime SWAPCHAIN_PRESENT_MODE_INFO_EXT = StructureType(value = 1000275003)
    comptime SWAPCHAIN_PRESENT_MODE_INFO_KHR = StructureType(value = 1000275003)
    comptime SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_EXT = StructureType(value = 1000275004)
    comptime SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR = StructureType(value = 1000275004)
    comptime RELEASE_SWAPCHAIN_IMAGES_INFO_EXT = StructureType(value = 1000275005)
    ...
    comptime PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES_EXT = StructureType(value = 1000276000)
    ...
    comptime PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_FEATURES_KHR = StructureType(value = 1000280000)
    comptime PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES = StructureType(value = 1000280001)
    comptime PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES_KHR = StructureType(value = 1000280001)
    ...
    comptime PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES_EXT = StructureType(value = 1000281001)
    ...
    comptime PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT = StructureType(value = 1000286000)
    comptime PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR = StructureType(value = 1000286000)
    comptime PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT = StructureType(value = 1000286001)
    ...
    comptime PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES_EXT = StructureType(value = 1000295000)
    comptime DEVICE_PRIVATE_DATA_CREATE_INFO = StructureType(value = 1000295001)
    comptime DEVICE_PRIVATE_DATA_CREATE_INFO_EXT = StructureType(value = 1000295001)
    comptime PRIVATE_DATA_SLOT_CREATE_INFO = StructureType(value = 1000295002)
    comptime PRIVATE_DATA_SLOT_CREATE_INFO_EXT = StructureType(value = 1000295002)
    comptime PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES = StructureType(value = 1000297000)
    comptime PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES_EXT = StructureType(value = 1000297000)
    ...
    comptime MEMORY_BARRIER_2_KHR = StructureType(value = 1000314000)
    comptime BUFFER_MEMORY_BARRIER_2 = StructureType(value = 1000314001)
    comptime BUFFER_MEMORY_BARRIER_2_KHR = StructureType(value = 1000314001)
    comptime IMAGE_MEMORY_BARRIER_2 = StructureType(value = 1000314002)
    comptime IMAGE_MEMORY_BARRIER_2_KHR = StructureType(value = 1000314002)
    comptime DEPENDENCY_INFO = StructureType(value = 1000314003)
    comptime DEPENDENCY_INFO_KHR = StructureType(value = 1000314003)
    comptime SUBMIT_INFO_2 = StructureType(value = 1000314004)
    comptime SUBMIT_INFO_2_KHR = StructureType(value = 1000314004)
    comptime SEMAPHORE_SUBMIT_INFO = StructureType(value = 1000314005)
    comptime SEMAPHORE_SUBMIT_INFO_KHR = StructureType(value = 1000314005)
    comptime COMMAND_BUFFER_SUBMIT_INFO = StructureType(value = 1000314006)
    comptime COMMAND_BUFFER_SUBMIT_INFO_KHR = StructureType(value = 1000314006)
    comptime PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES = StructureType(value = 1000314007)
    comptime PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES_KHR = StructureType(value = 1000314007)
    ...
    comptime PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES_KHR = StructureType(value = 1000325000)
    ...
    comptime PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT = StructureType(value = 1000335000)
    ...
    comptime COPY_BUFFER_INFO_2_KHR = StructureType(value = 1000337000)
    comptime COPY_IMAGE_INFO_2 = StructureType(value = 1000337001)
    comptime COPY_IMAGE_INFO_2_KHR = StructureType(value = 1000337001)
    comptime COPY_BUFFER_TO_IMAGE_INFO_2 = StructureType(value = 1000337002)
    comptime COPY_BUFFER_TO_IMAGE_INFO_2_KHR = StructureType(value = 1000337002)
    comptime COPY_IMAGE_TO_BUFFER_INFO_2 = StructureType(value = 1000337003)
    comptime COPY_IMAGE_TO_BUFFER_INFO_2_KHR = StructureType(value = 1000337003)
    comptime BLIT_IMAGE_INFO_2 = StructureType(value = 1000337004)
    comptime BLIT_IMAGE_INFO_2_KHR = StructureType(value = 1000337004)
    comptime RESOLVE_IMAGE_INFO_2 = StructureType(value = 1000337005)
    comptime RESOLVE_IMAGE_INFO_2_KHR = StructureType(value = 1000337005)
    comptime BUFFER_COPY_2 = StructureType(value = 1000337006)
    comptime BUFFER_COPY_2_KHR = StructureType(value = 1000337006)
    comptime IMAGE_COPY_2 = StructureType(value = 1000337007)
    comptime IMAGE_COPY_2_KHR = StructureType(value = 1000337007)
    comptime IMAGE_BLIT_2 = StructureType(value = 1000337008)
    comptime IMAGE_BLIT_2_KHR = StructureType(value = 1000337008)
    comptime BUFFER_IMAGE_COPY_2 = StructureType(value = 1000337009)
    comptime BUFFER_IMAGE_COPY_2_KHR = StructureType(value = 1000337009)
    comptime IMAGE_RESOLVE_2 = StructureType(value = 1000337010)
    comptime IMAGE_RESOLVE_2_KHR = StructureType(value = 1000337010)
    ...
    comptime SUBRESOURCE_LAYOUT_2_EXT = StructureType(value = 1000338002)
    comptime SUBRESOURCE_LAYOUT_2_KHR = StructureType(value = 1000338002)
    comptime IMAGE_SUBRESOURCE_2 = StructureType(value = 1000338003)
    comptime IMAGE_SUBRESOURCE_2_EXT = StructureType(value = 1000338003)
    comptime IMAGE_SUBRESOURCE_2_KHR = StructureType(value = 1000338003)
    ...
    comptime PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM = StructureType(value = 1000342000)
    ...
    comptime PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE = StructureType(value = 1000351000)
    comptime MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_EXT = StructureType(value = 1000351002)
    comptime MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE = StructureType(value = 1000351002)
    ...
    comptime FORMAT_PROPERTIES_3_KHR = StructureType(value = 1000360000)
    comptime PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_EXT = StructureType(value = 1000361000)
    ...
    comptime PHYSICAL_DEVICE_EXTERNAL_SCI_BUF_FEATURES_NV = StructureType(value = 1000374004)
    ...
    comptime PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES_EXT = StructureType(value = 1000388000)
    comptime PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES_KHR = StructureType(value = 1000388000)
    comptime QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES = StructureType(value = 1000388001)
    comptime QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES_EXT = StructureType(value = 1000388001)
    comptime QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES_KHR = StructureType(value = 1000388001)
    ...
    comptime PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES_KHR = StructureType(value = 1000413000)
    comptime PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES = StructureType(value = 1000413001)
    comptime PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES_KHR = StructureType(value = 1000413001)
    comptime DEVICE_BUFFER_MEMORY_REQUIREMENTS = StructureType(value = 1000413002)
    comptime DEVICE_BUFFER_MEMORY_REQUIREMENTS_KHR = StructureType(value = 1000413002)
    comptime DEVICE_IMAGE_MEMORY_REQUIREMENTS = StructureType(value = 1000413003)
    comptime DEVICE_IMAGE_MEMORY_REQUIREMENTS_KHR = StructureType(value = 1000413003)
    ...
    comptime PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES_KHR = StructureType(value = 1000416000)
    ...
    comptime PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_EXT = StructureType(value = 1000421000)
    ...
    comptime PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM = StructureType(value = 1000425000)
    comptime PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT = StructureType(value = 1000425001)
    comptime PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_QCOM = StructureType(value = 1000425001)
    comptime RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT = StructureType(value = 1000425002)
    comptime SUBPASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_QCOM = StructureType(value = 1000425002)
    ...
    comptime PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES_EXT = StructureType(value = 1000466000)
    ...
    comptime PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES_KHR = StructureType(value = 1000470000)
    comptime PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES = StructureType(value = 1000470001)
    comptime PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES_KHR = StructureType(value = 1000470001)
    comptime RENDERING_AREA_INFO = StructureType(value = 1000470003)
    comptime RENDERING_AREA_INFO_KHR = StructureType(value = 1000470003)
    comptime DEVICE_IMAGE_SUBRESOURCE_INFO = StructureType(value = 1000470004)
    comptime DEVICE_IMAGE_SUBRESOURCE_INFO_KHR = StructureType(value = 1000470004)
    comptime PIPELINE_CREATE_FLAGS_2_CREATE_INFO = StructureType(value = 1000470005)
    comptime PIPELINE_CREATE_FLAGS_2_CREATE_INFO_KHR = StructureType(value = 1000470005)
    comptime BUFFER_USAGE_FLAGS_2_CREATE_INFO = StructureType(value = 1000470006)
    comptime BUFFER_USAGE_FLAGS_2_CREATE_INFO_KHR = StructureType(value = 1000470006)
    ...
    comptime PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_KHR = StructureType(value = 1000525000)
    ...
    comptime PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES_KHR = StructureType(value = 1000528000)
    ...
    comptime PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES_KHR = StructureType(value = 1000544000)
    comptime PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES = StructureType(value = 1000545000)
    comptime PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES_KHR = StructureType(value = 1000545000)
    comptime PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES = StructureType(value = 1000545001)
    comptime PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES_KHR = StructureType(value = 1000545001)
    comptime BIND_MEMORY_STATUS = StructureType(value = 1000545002)
    comptime BIND_MEMORY_STATUS_KHR = StructureType(value = 1000545002)
    comptime BIND_DESCRIPTOR_SETS_INFO = StructureType(value = 1000545003)
    comptime BIND_DESCRIPTOR_SETS_INFO_KHR = StructureType(value = 1000545003)
    comptime PUSH_CONSTANTS_INFO = StructureType(value = 1000545004)
    comptime PUSH_CONSTANTS_INFO_KHR = StructureType(value = 1000545004)
    comptime PUSH_DESCRIPTOR_SET_INFO = StructureType(value = 1000545005)
    comptime PUSH_DESCRIPTOR_SET_INFO_KHR = StructureType(value = 1000545005)
    comptime PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO = StructureType(value = 1000545006)
    comptime PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO_KHR = StructureType(value = 1000545006)
...
struct SubpassContents(Equatable):
    ...
    comptime INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT = SubpassContents(value = 1000451000)
...
struct Result(Equatable, Writable):
    ...
    comptime _descriptions: Dict[Int32, StaticString] = {
        ...
        -1000011001: "VK_ERROR_VALIDATION_FAILED_EXT: None",
        ...
        -1000069000: "VK_ERROR_OUT_OF_POOL_MEMORY_KHR: None",
        -1000072003: "VK_ERROR_INVALID_EXTERNAL_HANDLE: None",
        -1000072003: "VK_ERROR_INVALID_EXTERNAL_HANDLE_KHR: None",
        -1000158000: "VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT: None",
        -1000161000: "VK_ERROR_FRAGMENTATION: None",
        -1000161000: "VK_ERROR_FRAGMENTATION_EXT: None",
        -1000174001: "VK_ERROR_NOT_PERMITTED: None",
        -1000174001: "VK_ERROR_NOT_PERMITTED_EXT: None",
        -1000174001: "VK_ERROR_NOT_PERMITTED_KHR: None",
        ...
        -1000257000: "VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR: None",
        ...
        1000297000: "VK_PIPELINE_COMPILE_REQUIRED_EXT: None",
    ...
    comptime ERROR_VALIDATION_FAILED_EXT = Result(value = -1000011001)
    ...
    comptime ERROR_OUT_OF_POOL_MEMORY_KHR = Result(value = -1000069000)
    comptime ERROR_INVALID_EXTERNAL_HANDLE = Result(value = -1000072003)
    comptime ERROR_INVALID_EXTERNAL_HANDLE_KHR = Result(value = -1000072003)
    ...
    comptime ERROR_FRAGMENTATION_EXT = Result(value = -1000161000)
    comptime ERROR_NOT_PERMITTED = Result(value = -1000174001)
    comptime ERROR_NOT_PERMITTED_EXT = Result(value = -1000174001)
    comptime ERROR_NOT_PERMITTED_KHR = Result(value = -1000174001)
    comptime ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT = Result(value = -1000255000)
    comptime ERROR_INVALID_DEVICE_ADDRESS_EXT = Result(value = -1000257000)
    comptime ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS = Result(value = -1000257000)
    comptime ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR = Result(value = -1000257000)
    ...
    comptime ERROR_PIPELINE_COMPILE_REQUIRED_EXT = Result(value = 1000297000)
    comptime PIPELINE_COMPILE_REQUIRED = Result(value = 1000297000)
    comptime PIPELINE_COMPILE_REQUIRED_EXT = Result(value = 1000297000)
    comptime ERROR_INCOMPATIBLE_SHADER_BINARY_EXT = Result(value = 1000482000)
...
struct DynamicState(Equatable):
    ...
    comptime LINE_STIPPLE_EXT = DynamicState(value = 1000259000)
    comptime LINE_STIPPLE_KHR = DynamicState(value = 1000259000)
    comptime CULL_MODE = DynamicState(value = 1000267000)
    comptime CULL_MODE_EXT = DynamicState(value = 1000267000)
    comptime FRONT_FACE = DynamicState(value = 1000267001)
    comptime FRONT_FACE_EXT = DynamicState(value = 1000267001)
    comptime PRIMITIVE_TOPOLOGY = DynamicState(value = 1000267002)
    comptime PRIMITIVE_TOPOLOGY_EXT = DynamicState(value = 1000267002)
    comptime VIEWPORT_WITH_COUNT = DynamicState(value = 1000267003)
    comptime VIEWPORT_WITH_COUNT_EXT = DynamicState(value = 1000267003)
    comptime SCISSOR_WITH_COUNT = DynamicState(value = 1000267004)
    comptime SCISSOR_WITH_COUNT_EXT = DynamicState(value = 1000267004)
    comptime VERTEX_INPUT_BINDING_STRIDE = DynamicState(value = 1000267005)
    comptime VERTEX_INPUT_BINDING_STRIDE_EXT = DynamicState(value = 1000267005)
    comptime DEPTH_TEST_ENABLE = DynamicState(value = 1000267006)
    comptime DEPTH_TEST_ENABLE_EXT = DynamicState(value = 1000267006)
    comptime DEPTH_WRITE_ENABLE = DynamicState(value = 1000267007)
    comptime DEPTH_WRITE_ENABLE_EXT = DynamicState(value = 1000267007)
    comptime DEPTH_COMPARE_OP = DynamicState(value = 1000267008)
    comptime DEPTH_COMPARE_OP_EXT = DynamicState(value = 1000267008)
    comptime DEPTH_BOUNDS_TEST_ENABLE = DynamicState(value = 1000267009)
    comptime DEPTH_BOUNDS_TEST_ENABLE_EXT = DynamicState(value = 1000267009)
    comptime STENCIL_TEST_ENABLE = DynamicState(value = 1000267010)
    comptime STENCIL_TEST_ENABLE_EXT = DynamicState(value = 1000267010)
    comptime STENCIL_OP = DynamicState(value = 1000267011)
    comptime STENCIL_OP_EXT = DynamicState(value = 1000267011)
    ...
    comptime RASTERIZER_DISCARD_ENABLE_EXT = DynamicState(value = 1000377001)
    comptime DEPTH_BIAS_ENABLE = DynamicState(value = 1000377002)
    comptime DEPTH_BIAS_ENABLE_EXT = DynamicState(value = 1000377002)
    comptime LOGIC_OP_EXT = DynamicState(value = 1000377003)
    comptime PRIMITIVE_RESTART_ENABLE = DynamicState(value = 1000377004)
    comptime PRIMITIVE_RESTART_ENABLE_EXT = DynamicState(value = 1000377004)
...
struct DescriptorUpdateTemplateType(Equatable):
    ...
    comptime DESCRIPTOR_SET_KHR = DescriptorUpdateTemplateType(value = 0)
    comptime PUSH_DESCRIPTORS = DescriptorUpdateTemplateType(value = 1)
    comptime PUSH_DESCRIPTORS_KHR = DescriptorUpdateTemplateType(value = 1)
...
struct ObjectType(Equatable):
    ...
    comptime DESCRIPTOR_UPDATE_TEMPLATE_KHR = ObjectType(value = 1000085000)
    ...
    comptime SAMPLER_YCBCR_CONVERSION_KHR = ObjectType(value = 1000156000)
    ...
    comptime PRIVATE_DATA_SLOT_EXT = ObjectType(value = 1000295000)
...
struct SemaphoreType(Equatable):
    ...
    comptime BINARY_KHR = SemaphoreType(value = 0)
    comptime TIMELINE = SemaphoreType(value = 1)
    comptime TIMELINE_KHR = SemaphoreType(value = 1)
...
struct PresentModeKHR(Equatable):
    ...
    comptime FIFO_LATEST_READY_EXT = PresentModeKHR(value = 1000361000)
...
struct ColorSpaceKHR(Equatable):
    ...
    comptime DCI_P3_LINEAR_EXT = ColorSpaceKHR(value = 1000104003)
...
struct TimeDomainKHR(Equatable):
    ...
    comptime DEVICE_EXT = TimeDomainKHR(value = 0)
    comptime DEVICE_KHR = TimeDomainKHR(value = 0)
    comptime CLOCK_MONOTONIC_EXT = TimeDomainKHR(value = 1)
    comptime CLOCK_MONOTONIC_KHR = TimeDomainKHR(value = 1)
    comptime CLOCK_MONOTONIC_RAW_EXT = TimeDomainKHR(value = 2)
    comptime CLOCK_MONOTONIC_RAW_KHR = TimeDomainKHR(value = 2)
    comptime QUERY_PERFORMANCE_COUNTER_EXT = TimeDomainKHR(value = 3)
...
struct DebugReportObjectTypeEXT(Equatable):
    ...
    comptime DESCRIPTOR_UPDATE_TEMPLATE_KHR_EXT = DebugReportObjectTypeEXT(value = 1000085000)
    ...
    comptime SAMPLER_YCBCR_CONVERSION_KHR_EXT = DebugReportObjectTypeEXT(value = 1000156000)
...
struct PointClippingBehavior(Equatable):
    ...
    comptime ALL_CLIP_PLANES_KHR = PointClippingBehavior(value = 0)
    comptime USER_CLIP_PLANES_ONLY = PointClippingBehavior(value = 1)
    comptime USER_CLIP_PLANES_ONLY_KHR = PointClippingBehavior(value = 1)
...
struct SamplerReductionMode(Equatable):
    ...
    comptime WEIGHTED_AVERAGE_EXT = SamplerReductionMode(value = 0)
    comptime MIN = SamplerReductionMode(value = 1)
    comptime MIN_EXT = SamplerReductionMode(value = 1)
    comptime MAX = SamplerReductionMode(value = 2)
    comptime MAX_EXT = SamplerReductionMode(value = 2)
...
struct TessellationDomainOrigin(Equatable):
    ...
    comptime UPPER_LEFT_KHR = TessellationDomainOrigin(value = 0)
    comptime LOWER_LEFT = TessellationDomainOrigin(value = 1)
    comptime LOWER_LEFT_KHR = TessellationDomainOrigin(value = 1)
...
struct SamplerYcbcrModelConversion(Equatable):
    ...
    comptime RGB_IDENTITY_KHR = SamplerYcbcrModelConversion(value = 0)
    comptime YCBCR_IDENTITY = SamplerYcbcrModelConversion(value = 1)
    comptime YCBCR_IDENTITY_KHR = SamplerYcbcrModelConversion(value = 1)
    comptime YCBCR_709 = SamplerYcbcrModelConversion(value = 2)
    comptime YCBCR_709_KHR = SamplerYcbcrModelConversion(value = 2)
    comptime YCBCR_601 = SamplerYcbcrModelConversion(value = 3)
    comptime YCBCR_601_KHR = SamplerYcbcrModelConversion(value = 3)
    comptime YCBCR_2020 = SamplerYcbcrModelConversion(value = 4)
    comptime YCBCR_2020_KHR = SamplerYcbcrModelConversion(value = 4)
...
struct SamplerYcbcrRange(Equatable):
    ...
    comptime ITU_FULL_KHR = SamplerYcbcrRange(value = 0)
    comptime ITU_NARROW = SamplerYcbcrRange(value = 1)
    comptime ITU_NARROW_KHR = SamplerYcbcrRange(value = 1)
...
struct ChromaLocation(Equatable):
    ...
    comptime COSITED_EVEN_KHR = ChromaLocation(value = 0)
    comptime MIDPOINT = ChromaLocation(value = 1)
    comptime MIDPOINT_KHR = ChromaLocation(value = 1)
...
struct QueueGlobalPriority(Equatable):
    ...
    comptime LOW_EXT = QueueGlobalPriority(value = 128)
    comptime LOW_KHR = QueueGlobalPriority(value = 128)
    comptime MEDIUM = QueueGlobalPriority(value = 256)
    comptime MEDIUM_EXT = QueueGlobalPriority(value = 256)
    comptime MEDIUM_KHR = QueueGlobalPriority(value = 256)
    comptime HIGH = QueueGlobalPriority(value = 512)
    comptime HIGH_EXT = QueueGlobalPriority(value = 512)
    comptime HIGH_KHR = QueueGlobalPriority(value = 512)
    comptime REALTIME = QueueGlobalPriority(value = 1024)
    comptime REALTIME_EXT = QueueGlobalPriority(value = 1024)
    comptime REALTIME_KHR = QueueGlobalPriority(value = 1024)
...
struct DriverId(Equatable):
    ...
    comptime AMD_PROPRIETARY_KHR = DriverId(value = 1)
    comptime AMD_OPEN_SOURCE = DriverId(value = 2)
    comptime AMD_OPEN_SOURCE_KHR = DriverId(value = 2)
    comptime MESA_RADV = DriverId(value = 3)
    comptime MESA_RADV_KHR = DriverId(value = 3)
    comptime NVIDIA_PROPRIETARY = DriverId(value = 4)
    comptime NVIDIA_PROPRIETARY_KHR = DriverId(value = 4)
    comptime INTEL_PROPRIETARY_WINDOWS = DriverId(value = 5)
    comptime INTEL_PROPRIETARY_WINDOWS_KHR = DriverId(value = 5)
    comptime INTEL_OPEN_SOURCE_MESA = DriverId(value = 6)
    comptime INTEL_OPEN_SOURCE_MESA_KHR = DriverId(value = 6)
    comptime IMAGINATION_PROPRIETARY = DriverId(value = 7)
    comptime IMAGINATION_PROPRIETARY_KHR = DriverId(value = 7)
    comptime QUALCOMM_PROPRIETARY = DriverId(value = 8)
    comptime QUALCOMM_PROPRIETARY_KHR = DriverId(value = 8)
    comptime ARM_PROPRIETARY = DriverId(value = 9)
    comptime ARM_PROPRIETARY_KHR = DriverId(value = 9)
    comptime GOOGLE_SWIFTSHADER = DriverId(value = 10)
    comptime GOOGLE_SWIFTSHADER_KHR = DriverId(value = 10)
    comptime GGP_PROPRIETARY = DriverId(value = 11)
    comptime GGP_PROPRIETARY_KHR = DriverId(value = 11)
    comptime BROADCOM_PROPRIETARY = DriverId(value = 12)
    comptime BROADCOM_PROPRIETARY_KHR = DriverId(value = 12)
...
struct CopyAccelerationStructureModeKHR(Equatable):
    ...
    comptime CLONE_NV = CopyAccelerationStructureModeKHR(value = 0)
    comptime COMPACT_KHR = CopyAccelerationStructureModeKHR(value = 1)
    comptime COMPACT_NV = CopyAccelerationStructureModeKHR(value = 1)
...
struct AccelerationStructureTypeKHR(Equatable):
    ...
    comptime TOP_LEVEL_NV = AccelerationStructureTypeKHR(value = 0)
    comptime BOTTOM_LEVEL_KHR = AccelerationStructureTypeKHR(value = 1)
    comptime BOTTOM_LEVEL_NV = AccelerationStructureTypeKHR(value = 1)
...
struct GeometryTypeKHR(Equatable):
    ...
    comptime TRIANGLES_NV = GeometryTypeKHR(value = 0)
    comptime AABBS_KHR = GeometryTypeKHR(value = 1)
    comptime AABBS_NV = GeometryTypeKHR(value = 1)
...
struct RayTracingShaderGroupTypeKHR(Equatable):
    ...
    comptime GENERAL_NV = RayTracingShaderGroupTypeKHR(value = 0)
    comptime TRIANGLES_HIT_GROUP_KHR = RayTracingShaderGroupTypeKHR(value = 1)
    comptime TRIANGLES_HIT_GROUP_NV = RayTracingShaderGroupTypeKHR(value = 1)
    comptime PROCEDURAL_HIT_GROUP_KHR = RayTracingShaderGroupTypeKHR(value = 2)
    comptime PROCEDURAL_HIT_GROUP_NV = RayTracingShaderGroupTypeKHR(value = 2)
...
struct ShaderFloatControlsIndependence(Equatable):
    ...
    comptime N_32_BIT_ONLY_KHR = ShaderFloatControlsIndependence(value = 0)
    comptime ALL = ShaderFloatControlsIndependence(value = 1)
    comptime ALL_KHR = ShaderFloatControlsIndependence(value = 1)
    comptime NONE = ShaderFloatControlsIndependence(value = 2)
    comptime NONE_KHR = ShaderFloatControlsIndependence(value = 2)
...
struct LineRasterizationMode(Equatable):
    ...
    comptime DEFAULT_EXT = LineRasterizationMode(value = 0)
    comptime DEFAULT_KHR = LineRasterizationMode(value = 0)
    comptime RECTANGULAR = LineRasterizationMode(value = 1)
    comptime RECTANGULAR_EXT = LineRasterizationMode(value = 1)
    comptime RECTANGULAR_KHR = LineRasterizationMode(value = 1)
    comptime BRESENHAM = LineRasterizationMode(value = 2)
    comptime BRESENHAM_EXT = LineRasterizationMode(value = 2)
    comptime BRESENHAM_KHR = LineRasterizationMode(value = 2)
    comptime RECTANGULAR_SMOOTH = LineRasterizationMode(value = 3)
    comptime RECTANGULAR_SMOOTH_EXT = LineRasterizationMode(value = 3)
    comptime RECTANGULAR_SMOOTH_KHR = LineRasterizationMode(value = 3)
...
struct PipelineRobustnessBufferBehavior(Equatable):
    ...
    comptime DEVICE_DEFAULT_EXT = PipelineRobustnessBufferBehavior(value = 0)
    comptime DISABLED = PipelineRobustnessBufferBehavior(value = 1)
    comptime DISABLED_EXT = PipelineRobustnessBufferBehavior(value = 1)
    comptime ROBUST_BUFFER_ACCESS = PipelineRobustnessBufferBehavior(value = 2)
    comptime ROBUST_BUFFER_ACCESS_EXT = PipelineRobustnessBufferBehavior(value = 2)
    comptime ROBUST_BUFFER_ACCESS_2 = PipelineRobustnessBufferBehavior(value = 3)
    comptime ROBUST_BUFFER_ACCESS_2_EXT = PipelineRobustnessBufferBehavior(value = 3)
...
struct PipelineRobustnessImageBehavior(Equatable):
    ...
    comptime DEVICE_DEFAULT_EXT = PipelineRobustnessImageBehavior(value = 0)
    comptime DISABLED = PipelineRobustnessImageBehavior(value = 1)
    comptime DISABLED_EXT = PipelineRobustnessImageBehavior(value = 1)
    comptime ROBUST_IMAGE_ACCESS = PipelineRobustnessImageBehavior(value = 2)
    comptime ROBUST_IMAGE_ACCESS_EXT = PipelineRobustnessImageBehavior(value = 2)
    comptime ROBUST_IMAGE_ACCESS_2 = PipelineRobustnessImageBehavior(value = 3)
    comptime ROBUST_IMAGE_ACCESS_2_EXT = PipelineRobustnessImageBehavior(value = 3)
...
struct ScopeKHR(Equatable):
    ...
    comptime DEVICE_NV = ScopeKHR(value = 1)
    comptime WORKGROUP_KHR = ScopeKHR(value = 2)
    comptime WORKGROUP_NV = ScopeKHR(value = 2)
    comptime SUBGROUP_KHR = ScopeKHR(value = 3)
    comptime SUBGROUP_NV = ScopeKHR(value = 3)
    comptime QUEUE_FAMILY_KHR = ScopeKHR(value = 5)
    comptime QUEUE_FAMILY_NV = ScopeKHR(value = 5)
...
struct ComponentTypeKHR(Equatable):
    ...
    comptime FLOAT16_NV = ComponentTypeKHR(value = 0)
    comptime FLOAT32_KHR = ComponentTypeKHR(value = 1)
    comptime FLOAT32_NV = ComponentTypeKHR(value = 1)
    comptime FLOAT64_KHR = ComponentTypeKHR(value = 2)
    comptime FLOAT64_NV = ComponentTypeKHR(value = 2)
    comptime SINT8_KHR = ComponentTypeKHR(value = 3)
    comptime SINT8_NV = ComponentTypeKHR(value = 3)
    comptime SINT16_KHR = ComponentTypeKHR(value = 4)
    comptime SINT16_NV = ComponentTypeKHR(value = 4)
    comptime SINT32_KHR = ComponentTypeKHR(value = 5)
    comptime SINT32_NV = ComponentTypeKHR(value = 5)
    comptime SINT64_KHR = ComponentTypeKHR(value = 6)
    comptime SINT64_NV = ComponentTypeKHR(value = 6)
    comptime UINT8_KHR = ComponentTypeKHR(value = 7)
    comptime UINT8_NV = ComponentTypeKHR(value = 7)
    comptime UINT16_KHR = ComponentTypeKHR(value = 8)
    comptime UINT16_NV = ComponentTypeKHR(value = 8)
    comptime UINT32_KHR = ComponentTypeKHR(value = 9)
    comptime UINT32_NV = ComponentTypeKHR(value = 9)
    comptime UINT64_KHR = ComponentTypeKHR(value = 10)
    comptime UINT64_NV = ComponentTypeKHR(value = 10)
    ...
    comptime FLOAT_E4M3_NV = ComponentTypeKHR(value = 1000491002)
    comptime FLOAT8_E5M2_EXT = ComponentTypeKHR(value = 1000491003)
    comptime FLOAT_E5M2_NV = ComponentTypeKHR(value = 1000491003)
