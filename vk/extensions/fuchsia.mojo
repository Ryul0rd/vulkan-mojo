...
struct ImagepipeSurface(Copyable):    var _vk_create_image_pipe_surface_fuchsia: fn(
        instance: Instance,
        pCreateInfo: Ptr[ImagePipeSurfaceCreateInfoFUCHSIA, MutOrigin.external],
...
struct ExternalMemory(Copyable):    var _vk_get_memory_zircon_handle_fuchsia: fn(
        device: Device,
        pGetZirconHandleInfo: Ptr[MemoryGetZirconHandleInfoFUCHSIA, MutOrigin.external],
...
struct ExternalSemaphore(Copyable):    var _vk_import_semaphore_zircon_handle_fuchsia: fn(
        device: Device,
        pImportSemaphoreZirconHandleInfo: Ptr[ImportSemaphoreZirconHandleInfoFUCHSIA, MutOrigin.external],
    ) -> Result
    var _vk_get_semaphore_zircon_handle_fuchsia: fn(
        device: Device,
        pGetZirconHandleInfo: Ptr[SemaphoreGetZirconHandleInfoFUCHSIA, MutOrigin.external],
        pZirconHandle: Ptr[zx_handle_t, MutOrigin.external],
    ) -> Result
...
struct BufferCollection(Copyable):    var _vk_create_buffer_collection_fuchsia: fn(
        device: Device,
        pCreateInfo: Ptr[BufferCollectionCreateInfoFUCHSIA, MutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, MutOrigin.external],
    ...
    var _vk_set_buffer_collection_image_constraints_fuchsia: fn(
        ...
        pImageConstraintsInfo: Ptr[ImageConstraintsInfoFUCHSIA, MutOrigin.external],
    ) -> Result
    var _vk_set_buffer_collection_buffer_constraints_fuchsia: fn(
        device: Device,
        collection: BufferCollectionFUCHSIA,
        pBufferConstraintsInfo: Ptr[BufferConstraintsInfoFUCHSIA, MutOrigin.external],
    ) -> Result
