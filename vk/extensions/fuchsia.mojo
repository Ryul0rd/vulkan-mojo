...
struct ExternalMemory(Copyable):
    ...
    var _get_memory_zircon_handle: def(
        device: Device,
        p_get_zircon_handle_info: Ptr[MemoryGetZirconHandleInfoFUCHSIA, ImmutUntrackedOrigin],
        p_zircon_handle: Ptr[zx_handle_t, MutUntrackedOrigin],
    ) thin abi("C") -> Result
    var _get_memory_zircon_handle_properties: def(
        device: Device,
        handle_type: ExternalMemoryHandleTypeFlagBits,
        zircon_handle: zx_handle_t,
        p_memory_zircon_handle_properties: Ptr[MemoryZirconHandlePropertiesFUCHSIA, MutUntrackedOrigin],
    ) thin abi("C") -> Result
    ...
    def get_memory_zircon_handle(
        ...
        """
        return self._get_memory_zircon_handle(
            device,
            Ptr(to=get_zircon_handle_info).bitcast[MemoryGetZirconHandleInfoFUCHSIA]().unsafe_origin_cast[ImmutUntrackedOrigin](),
            Ptr(to=zircon_handle).bitcast[zx_handle_t]().unsafe_origin_cast[MutUntrackedOrigin](),
        )
    ...
    def get_memory_zircon_handle_properties(
        ...
        return self._get_memory_zircon_handle_properties(
            ...
            handle_type,
            zircon_handle,
            Ptr(to=memory_zircon_handle_properties).bitcast[MemoryZirconHandlePropertiesFUCHSIA]().unsafe_origin_cast[MutUntrackedOrigin](),
        )
...
struct ExternalSemaphore(Copyable):
    ...
    var _import_semaphore_zircon_handle: def(
        device: Device,
        p_import_semaphore_zircon_handle_info: Ptr[ImportSemaphoreZirconHandleInfoFUCHSIA, ImmutUntrackedOrigin],
    ) thin abi("C") -> Result
    var _get_semaphore_zircon_handle: def(
        device: Device,
        p_get_zircon_handle_info: Ptr[SemaphoreGetZirconHandleInfoFUCHSIA, ImmutUntrackedOrigin],
        p_zircon_handle: Ptr[zx_handle_t, MutUntrackedOrigin],
    ) thin abi("C") -> Result
    ...
    def import_semaphore_zircon_handle(
        ...
        """
        return self._import_semaphore_zircon_handle(
            device,
            Ptr(to=import_semaphore_zircon_handle_info).bitcast[ImportSemaphoreZirconHandleInfoFUCHSIA]().unsafe_origin_cast[ImmutUntrackedOrigin](),
        )
    ...
    def get_semaphore_zircon_handle(
        ...
        return self._get_semaphore_zircon_handle(
            device,
            Ptr(to=get_zircon_handle_info).bitcast[SemaphoreGetZirconHandleInfoFUCHSIA]().unsafe_origin_cast[ImmutUntrackedOrigin](),
            Ptr(to=zircon_handle).bitcast[zx_handle_t]().unsafe_origin_cast[MutUntrackedOrigin](),
        )
...
struct BufferCollection(Copyable):
    ...
    var _set_buffer_collection_image_constraints: def(
        ...
        p_image_constraints_info: Ptr[ImageConstraintsInfoFUCHSIA, ImmutUntrackedOrigin],
    ) thin abi("C") -> Result
    var _set_buffer_collection_buffer_constraints: def(
        device: Device,
        collection: BufferCollectionFUCHSIA,
        p_buffer_constraints_info: Ptr[BufferConstraintsInfoFUCHSIA, ImmutUntrackedOrigin],
    ) thin abi("C") -> Result
    ...
    var _get_buffer_collection_properties: def(
        device: Device,
        collection: BufferCollectionFUCHSIA,
        p_properties: Ptr[BufferCollectionPropertiesFUCHSIA, MutUntrackedOrigin],
    ) thin abi("C") -> Result
    ...
    def set_buffer_collection_image_constraints(
        ...
        return self._set_buffer_collection_image_constraints(
            device,
            collection,
            Ptr(to=image_constraints_info).bitcast[ImageConstraintsInfoFUCHSIA]().unsafe_origin_cast[ImmutUntrackedOrigin](),
        )
    ...
    def get_buffer_collection_properties(
        ...
        """
        return self._get_buffer_collection_properties(
            device,
            collection,
            Ptr(to=properties).bitcast[BufferCollectionPropertiesFUCHSIA]().unsafe_origin_cast[MutUntrackedOrigin](),
        )
