...
struct DebugReport(Copyable):    var _vk_create_debug_report_callback_ext: fn(
        instance: Instance,
        pCreateInfo: Ptr[DebugReportCallbackCreateInfoEXT, ImmutOrigin.external],
    ...
    var _vk_debug_report_message_ext: fn(
        ...
        location: UInt,
        messageCode: Int32,
        pLayerPrefix: Ptr[c_char, ImmutOrigin.external],
        pMessage: Ptr[c_char, ImmutOrigin.external],
    )


struct DebugMarker(Copyable):    var _vk_debug_marker_set_object_tag_ext: fn(
        device: Device, pTagInfo: Ptr[DebugMarkerObjectTagInfoEXT, ImmutOrigin.external]
    ) -> Result
    var _vk_debug_marker_set_object_name_ext: fn(
        device: Device, pNameInfo: Ptr[DebugMarkerObjectNameInfoEXT, ImmutOrigin.external]
    ) -> Result
    var _vk_cmd_debug_marker_begin_ext: fn(
        commandBuffer: CommandBuffer,
        pMarkerInfo: Ptr[DebugMarkerMarkerInfoEXT, ImmutOrigin.external],
    )
...
struct TransformFeedback(Copyable):    var _vk_cmd_bind_transform_feedback_buffers_ext: fn(
    ...
    var _vk_cmd_begin_transform_feedback_ext: fn(
        ...
        pCounterBuffers: Ptr[Buffer, ImmutOrigin.external],
        pCounterBufferOffsets: Ptr[DeviceSize, ImmutOrigin.external],
    )
...
struct ConditionalRendering(Copyable):    var _vk_cmd_begin_conditional_rendering_ext: fn(
        commandBuffer: CommandBuffer,
        pConditionalRenderingBegin: Ptr[ConditionalRenderingBeginInfoEXT, ImmutOrigin.external],
    )
...
struct DisplayControl(Copyable):    var _vk_display_power_control_ext: fn(
        device: Device,
        display: DisplayKHR,
        pDisplayPowerInfo: Ptr[DisplayPowerInfoEXT, ImmutOrigin.external],
    ) -> Result
    var _vk_register_device_event_ext: fn(
        device: Device,
        pDeviceEventInfo: Ptr[DeviceEventInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_register_display_event_ext: fn(
        device: Device,
        display: DisplayKHR,
        pDisplayEventInfo: Ptr[DisplayEventInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
        pFence: Ptr[Fence, MutOrigin.external],
    ) -> Result
...
struct DiscardRectangles(Copyable):    var _vk_cmd_set_discard_rectangle_ext: fn(
        ...
        pDiscardRectangles: Ptr[Rect2D, ImmutOrigin.external],
    )
...
struct HdrMetadata(Copyable):    var _vk_set_hdr_metadata_ext: fn(
        ...
        pSwapchains: Ptr[SwapchainKHR, ImmutOrigin.external],
        pMetadata: Ptr[HdrMetadataEXT, ImmutOrigin.external],
    )


struct DebugUtils(Copyable):    var _vk_set_debug_utils_object_name_ext: fn(
        device: Device, pNameInfo: Ptr[DebugUtilsObjectNameInfoEXT, ImmutOrigin.external]
    ) -> Result
    var _vk_set_debug_utils_object_tag_ext: fn(
        device: Device, pTagInfo: Ptr[DebugUtilsObjectTagInfoEXT, ImmutOrigin.external]
    ) -> Result
    var _vk_queue_begin_debug_utils_label_ext: fn(
        queue: Queue, pLabelInfo: Ptr[DebugUtilsLabelEXT, ImmutOrigin.external]
    )
    ...
    var _vk_cmd_begin_debug_utils_label_ext: fn(
        commandBuffer: CommandBuffer, pLabelInfo: Ptr[DebugUtilsLabelEXT, ImmutOrigin.external]
    )
    ...
    var _vk_create_debug_utils_messenger_ext: fn(
        instance: Instance,
        pCreateInfo: Ptr[DebugUtilsMessengerCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_submit_debug_utils_message_ext: fn(
        ...
        pCallbackData: Ptr[DebugUtilsMessengerCallbackDataEXT, ImmutOrigin.external],
    )


struct SampleLocations(Copyable):    var _vk_cmd_set_sample_locations_ext: fn(
        commandBuffer: CommandBuffer,
        pSampleLocationsInfo: Ptr[SampleLocationsInfoEXT, ImmutOrigin.external],
    )
...
struct ValidationCache(Copyable):    var _vk_create_validation_cache_ext: fn(
        device: Device,
        pCreateInfo: Ptr[ValidationCacheCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_merge_validation_caches_ext: fn(
        ...
        pSrcCaches: Ptr[ValidationCacheEXT, ImmutOrigin.external],
    ) -> Result
...
struct ExternalMemoryHost(Copyable):    var _vk_get_memory_host_pointer_properties_ext: fn(
        ...
        pHostPointer: Ptr[NoneType, ImmutOrigin.external],
...
struct MetalSurface(Copyable):    var _vk_create_metal_surface_ext: fn(
        instance: Instance,
        pCreateInfo: Ptr[MetalSurfaceCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
...
struct HeadlessSurface(Copyable):    var _vk_create_headless_surface_ext: fn(
        instance: Instance,
        pCreateInfo: Ptr[HeadlessSurfaceCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
        pSurface: Ptr[SurfaceKHR, MutOrigin.external],
    ) -> Result
...
struct DepthBiasControl(Copyable):    var _vk_cmd_set_depth_bias_2_ext: fn(
        commandBuffer: CommandBuffer, pDepthBiasInfo: Ptr[DepthBiasInfoEXT, ImmutOrigin.external]
    )
...
struct DescriptorBuffer(Copyable):    var _vk_get_descriptor_set_layout_size_ext: fn(
    ...
    var _vk_get_descriptor_ext: fn(
        device: Device,
        pDescriptorInfo: Ptr[DescriptorGetInfoEXT, ImmutOrigin.external],
        dataSize: UInt,
    ...
    var _vk_cmd_bind_descriptor_buffers_ext: fn(
        commandBuffer: CommandBuffer,
        bufferCount: UInt32,
        pBindingInfos: Ptr[DescriptorBufferBindingInfoEXT, ImmutOrigin.external],
    )
    var _vk_cmd_set_descriptor_buffer_offsets_ext: fn(
        ...
        firstSet: UInt32,
        setCount: UInt32,
        pBufferIndices: Ptr[UInt32, ImmutOrigin.external],
        pOffsets: Ptr[DeviceSize, ImmutOrigin.external],
    )
    ...
    var _vk_get_buffer_opaque_capture_descriptor_data_ext: fn(
        device: Device,
        pInfo: Ptr[BufferCaptureDescriptorDataInfoEXT, ImmutOrigin.external],
        pData: Ptr[NoneType, MutOrigin.external],
    ) -> Result
    var _vk_get_image_opaque_capture_descriptor_data_ext: fn(
        device: Device,
        pInfo: Ptr[ImageCaptureDescriptorDataInfoEXT, ImmutOrigin.external],
        pData: Ptr[NoneType, MutOrigin.external],
    ) -> Result
    var _vk_get_image_view_opaque_capture_descriptor_data_ext: fn(
        device: Device,
        pInfo: Ptr[ImageViewCaptureDescriptorDataInfoEXT, ImmutOrigin.external],
        pData: Ptr[NoneType, MutOrigin.external],
    ) -> Result
    var _vk_get_sampler_opaque_capture_descriptor_data_ext: fn(
        device: Device,
        pInfo: Ptr[SamplerCaptureDescriptorDataInfoEXT, ImmutOrigin.external],
        pData: Ptr[NoneType, MutOrigin.external],
    ) -> Result
    var _vk_get_acceleration_structure_opaque_capture_descriptor_data_ext: fn(
        device: Device,
        pInfo: Ptr[AccelerationStructureCaptureDescriptorDataInfoEXT, ImmutOrigin.external],
        pData: Ptr[NoneType, MutOrigin.external],
    ) -> Result
...
struct DirectfbSurface(Copyable):    var _vk_create_direct_fb_surface_ext: fn(
        instance: Instance,
        pCreateInfo: Ptr[DirectFBSurfaceCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
        pSurface: Ptr[SurfaceKHR, MutOrigin.external],
    ) -> Result
...
struct VertexInputDynamicState(Copyable):    var _vk_cmd_set_vertex_input_ext: fn(
        ...
        pVertexBindingDescriptions: Ptr[VertexInputBindingDescription2EXT, ImmutOrigin.external],
        vertexAttributeDescriptionCount: UInt32,
        pVertexAttributeDescriptions: Ptr[VertexInputAttributeDescription2EXT, ImmutOrigin.external],
    )


struct PipelineProperties(Copyable):    var _vk_get_pipeline_properties_ext: fn(
        device: Device,
        pPipelineInfo: Ptr[PipelineInfoEXT, ImmutOrigin.external],
...
struct ColorWriteEnable(Copyable):    var _vk_cmd_set_color_write_enable_ext: fn(
        ...
        pColorWriteEnables: Ptr[Bool32, ImmutOrigin.external],
    )
...
struct MultiDraw(Copyable):    var _vk_cmd_draw_multi_ext: fn(
        commandBuffer: CommandBuffer,
        drawCount: UInt32,
        pVertexInfo: Ptr[MultiDrawInfoEXT, ImmutOrigin.external],
        instanceCount: UInt32,
        firstInstance: UInt32,
        stride: UInt32,
    )
    var _vk_cmd_draw_multi_indexed_ext: fn(
        commandBuffer: CommandBuffer,
        drawCount: UInt32,
        pIndexInfo: Ptr[MultiDrawIndexedInfoEXT, ImmutOrigin.external],
        instanceCount: UInt32,
        firstInstance: UInt32,
        stride: UInt32,
        pVertexOffset: Ptr[Int32, ImmutOrigin.external],
    )


struct OpacityMicromap(Copyable):    var _vk_create_micromap_ext: fn(
        device: Device,
        pCreateInfo: Ptr[MicromapCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_cmd_build_micromaps_ext: fn(
        commandBuffer: CommandBuffer,
        infoCount: UInt32,
        pInfos: Ptr[MicromapBuildInfoEXT, ImmutOrigin.external],
    )
    ...
    var _vk_copy_micromap_ext: fn(
        device: Device,
        deferredOperation: DeferredOperationKHR,
        pInfo: Ptr[CopyMicromapInfoEXT, ImmutOrigin.external],
    ) -> Result
    var _vk_copy_micromap_to_memory_ext: fn(
        device: Device,
        deferredOperation: DeferredOperationKHR,
        pInfo: Ptr[CopyMicromapToMemoryInfoEXT, ImmutOrigin.external],
    ) -> Result
    var _vk_copy_memory_to_micromap_ext: fn(
        device: Device,
        deferredOperation: DeferredOperationKHR,
        pInfo: Ptr[CopyMemoryToMicromapInfoEXT, ImmutOrigin.external],
    ) -> Result
    var _vk_write_micromaps_properties_ext: fn(
        device: Device,
        micromapCount: UInt32,
        pMicromaps: Ptr[MicromapEXT, ImmutOrigin.external],
        queryType: QueryType,
        dataSize: UInt,
        pData: Ptr[NoneType, MutOrigin.external],
        stride: UInt,
    ...
    var _vk_cmd_copy_micromap_ext: fn(
        commandBuffer: CommandBuffer, pInfo: Ptr[CopyMicromapInfoEXT, ImmutOrigin.external]
    )
    var _vk_cmd_copy_micromap_to_memory_ext: fn(
        commandBuffer: CommandBuffer, pInfo: Ptr[CopyMicromapToMemoryInfoEXT, ImmutOrigin.external]
    )
    var _vk_cmd_copy_memory_to_micromap_ext: fn(
        commandBuffer: CommandBuffer, pInfo: Ptr[CopyMemoryToMicromapInfoEXT, ImmutOrigin.external]
    )
    ...
    var _vk_get_device_micromap_compatibility_ext: fn(
        device: Device,
        pVersionInfo: Ptr[MicromapVersionInfoEXT, ImmutOrigin.external],
    ...
    var _vk_get_micromap_build_sizes_ext: fn(
        ...
        pBuildInfo: Ptr[MicromapBuildInfoEXT, ImmutOrigin.external],
...
struct ExtendedDynamicState3(Copyable):    var _vk_cmd_set_depth_clamp_enable_ext: fn(
    ...
    var _vk_cmd_set_sample_mask_ext: fn(
        commandBuffer: CommandBuffer,
        samples: SampleCountFlagBits,
        pSampleMask: Ptr[SampleMask, ImmutOrigin.external],
    )
    ...
    var _vk_cmd_set_color_blend_enable_ext: fn(
        ...
        attachmentCount: UInt32,
        pColorBlendEnables: Ptr[Bool32, ImmutOrigin.external],
    )
    var _vk_cmd_set_color_blend_equation_ext: fn(
        commandBuffer: CommandBuffer,
        firstAttachment: UInt32,
        attachmentCount: UInt32,
        pColorBlendEquations: Ptr[ColorBlendEquationEXT, ImmutOrigin.external],
    )
    var _vk_cmd_set_color_write_mask_ext: fn(
        commandBuffer: CommandBuffer,
        firstAttachment: UInt32,
        attachmentCount: UInt32,
        pColorWriteMasks: Ptr[ColorComponentFlags, ImmutOrigin.external],
    )
    ...
    var _vk_cmd_set_color_blend_advanced_ext: fn(
        ...
        firstAttachment: UInt32,
        attachmentCount: UInt32,
        pColorBlendAdvanced: Ptr[ColorBlendAdvancedEXT, ImmutOrigin.external],
    )
    ...
    var _vk_cmd_set_viewport_swizzle_nv: fn(
        ...
        viewportCount: UInt32,
        pViewportSwizzles: Ptr[ViewportSwizzleNV, ImmutOrigin.external],
    )
    ...
    var _vk_cmd_set_coverage_modulation_table_nv: fn(
        ...
        pCoverageModulationTable: Ptr[Float32, ImmutOrigin.external],
    )
...
struct ShaderObject(Copyable):    var _vk_create_shaders_ext: fn(
        ...
        pCreateInfos: Ptr[ShaderCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_cmd_bind_shaders_ext: fn(
        commandBuffer: CommandBuffer,
        stageCount: UInt32,
        pStages: Ptr[ShaderStageFlagBits, ImmutOrigin.external],
        pShaders: Ptr[ShaderEXT, ImmutOrigin.external],
    )
    ...
    var _vk_cmd_set_depth_clamp_range_ext: fn(
        ...
        pDepthClampRange: Ptr[DepthClampRangeEXT, ImmutOrigin.external],
    )
...
struct DeviceGeneratedCommands(Copyable):    var _vk_get_generated_commands_memory_requirements_ext: fn(
        device: Device,
        pInfo: Ptr[GeneratedCommandsMemoryRequirementsInfoEXT, ImmutOrigin.external],
        pMemoryRequirements: Ptr[MemoryRequirements2, MutOrigin.external],
    )
    var _vk_cmd_preprocess_generated_commands_ext: fn(
        commandBuffer: CommandBuffer,
        pGeneratedCommandsInfo: Ptr[GeneratedCommandsInfoEXT, ImmutOrigin.external],
    ...
    var _vk_create_indirect_commands_layout_ext: fn(
        device: Device,
        pCreateInfo: Ptr[IndirectCommandsLayoutCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_create_indirect_execution_set_ext: fn(
        device: Device,
        pCreateInfo: Ptr[IndirectExecutionSetCreateInfoEXT, ImmutOrigin.external],
        pAllocator: Ptr[AllocationCallbacks, ImmutOrigin.external],
    ...
    var _vk_update_indirect_execution_set_pipeline_ext: fn(
        ...
        pExecutionSetWrites: Ptr[WriteIndirectExecutionSetPipelineEXT, ImmutOrigin.external],
    )
    var _vk_update_indirect_execution_set_shader_ext: fn(
        device: Device,
        indirectExecutionSet: IndirectExecutionSetEXT,
        executionSetWriteCount: UInt32,
        pExecutionSetWrites: Ptr[WriteIndirectExecutionSetShaderEXT, ImmutOrigin.external],
    )
...
struct ExternalMemoryMetal(Copyable):    var _vk_get_memory_metal_handle_ext: fn(
        device: Device,
        pGetMetalHandleInfo: Ptr[MemoryGetMetalHandleInfoEXT, ImmutOrigin.external],
        pHandle: Ptr[Ptr[NoneType, MutOrigin.external], MutOrigin.external],
    ) -> Result
    var _vk_get_memory_metal_handle_properties_ext: fn(
        device: Device,
        handleType: ExternalMemoryHandleTypeFlagBits,
        pHandle: Ptr[NoneType, ImmutOrigin.external],
...
struct FragmentDensityMapOffset(Copyable):    var _vk_cmd_end_rendering_2_ext: fn(
        commandBuffer: CommandBuffer,
        pRenderingEndInfo: Ptr[RenderingEndInfoEXT, ImmutOrigin.external],
    )
