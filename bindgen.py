...
class MojoBaseType:
    name: str
    parameters: List[MojoOriginLiteral | MojoParametricOrigin | str] = field(default_factory=list) # type: ignore[reportUnknownVariableType]
...
class MojoSpanType:
    ...
    def __str__(self) -> str:
        return f"Span[{self.element_type}, {self.origin}]"
...
MojoType = MojoBaseType | MojoPointerType | MojoArrayType | MojoSpanType | MojoFnType | MojoParametricOrigin
    ...
    for member in members:
        ...
        if decl.bit_width is not None:
            ...
            if start_new_group:
                ...
                packed_group_index += 1
                packed_offset = 0
                physical_fields.append(PhysicalField(
                    name=f"_packed{packed_group_index}",
                    type=MojoBaseType("UInt32"),
                ))
            logical_fields.append(PackedLogicalField(
                name=field_name,
                first_in_group=start_new_group,
...
class MojoUnion:
    ...
    def __str__(self) -> str:
        ...
        for type in unique_types:
            parts.append(
                f"\n"
                f"    def __init__(out self, value: {type}):\n"
...
class MojoEnum:
    ...
    def emit_result(self) -> str:
        ...
        parts.append(
            ...
            "        return self.value() < 0\n"
            "\n"
            "    def raise_on_error(self) raises:\n"
            "        if self.is_error():\n"
            '            raise String(self)\n'
            "\n"
...
class MojoFlags:
    ...
    def __str__(self) -> str:
        ...
        parts.append(
            ...
            f"\n"
            f"    @implicit\n"
            f"    def __init__(out self, bit: {self.bits_name}):\n"
            ...
            f"\n"
            f"    def __ror__(self, other: {self.name}) -> Self:\n"
            f"        return Self(value = self.value() | other.value())\n"
            f"\n"
            f"    def __ior__(mut self, other: {self.name}):\n"
            f"        self._value |= other.value()\n"
            f"\n"
            f"    def __and__(self, other: {self.name}) -> Self:\n"
            f"        return Self(value = self.value() & other.value())\n"
            f"\n"
            f"    def __rand__(self, other: {self.name}) -> Self:\n"
            f"        return Self(value = self.value() & other.value())\n"
            f"\n"
            f"    def __iand__(mut self, other: {self.name}):\n"
            f"        self._value &= other.value()\n"
            f"\n"
            f"    def __contains__(self, other: {self.name}) -> Bool:\n"
            f"        return self.is_superset(other)\n"
            f"\n"
            f"    def is_subset(self, other: {self.name}) -> Bool:\n"
            f"        return self & other == self\n"
            f"\n"
            f"    def is_superset(self, other: {self.name}) -> Bool:\n"
...
def bind_external_types(files: Dict[str, str], registry: Registry):
    ...
    EXTERNAL_TYPES: List[MojoExternalType] = [
        ...
        # H.264
        MojoEnum("StdVideoH264ProfileIdc", "Int32", [
            MojoEnumValue("BASELINE", 66),
            MojoEnumValue("MAIN", 77),
            MojoEnumValue("HIGH", 100),
            MojoEnumValue("HIGH_444_PREDICTIVE", 244),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        MojoEnum("StdVideoH264LevelIdc", "Int32", [
            MojoEnumValue("LEVEL_1_0", 0),
            MojoEnumValue("LEVEL_1_1", 1),
            MojoEnumValue("LEVEL_1_2", 2),
            MojoEnumValue("LEVEL_1_3", 3),
            MojoEnumValue("LEVEL_2_0", 4),
            MojoEnumValue("LEVEL_2_1", 5),
            MojoEnumValue("LEVEL_2_2", 6),
            MojoEnumValue("LEVEL_3_0", 7),
            MojoEnumValue("LEVEL_3_1", 8),
            MojoEnumValue("LEVEL_3_2", 9),
            MojoEnumValue("LEVEL_4_0", 10),
            MojoEnumValue("LEVEL_4_1", 11),
            MojoEnumValue("LEVEL_4_2", 12),
            MojoEnumValue("LEVEL_5_0", 13),
            MojoEnumValue("LEVEL_5_1", 14),
            MojoEnumValue("LEVEL_5_2", 15),
            MojoEnumValue("LEVEL_6_0", 16),
            MojoEnumValue("LEVEL_6_1", 17),
            MojoEnumValue("LEVEL_6_2", 18),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        ...
        # H.265/HEVC
        MojoEnum("StdVideoH265ProfileIdc", "Int32", [
            MojoEnumValue("MAIN", 1),
            MojoEnumValue("MAIN_10", 2),
            MojoEnumValue("MAIN_STILL_PICTURE", 3),
            MojoEnumValue("FORMAT_RANGE_EXTENSIONS", 4),
            MojoEnumValue("SCC_EXTENSIONS", 9),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        MojoEnum("StdVideoH265LevelIdc", "Int32", [
            MojoEnumValue("LEVEL_1_0", 0),
            MojoEnumValue("LEVEL_2_0", 1),
            MojoEnumValue("LEVEL_2_1", 2),
            MojoEnumValue("LEVEL_3_0", 3),
            MojoEnumValue("LEVEL_3_1", 4),
            MojoEnumValue("LEVEL_4_0", 5),
            MojoEnumValue("LEVEL_4_1", 6),
            MojoEnumValue("LEVEL_5_0", 7),
            MojoEnumValue("LEVEL_5_1", 8),
            MojoEnumValue("LEVEL_5_2", 9),
            MojoEnumValue("LEVEL_6_0", 10),
            MojoEnumValue("LEVEL_6_1", 11),
            MojoEnumValue("LEVEL_6_2", 12),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        ...
        # AV1
        MojoEnum("StdVideoAV1Profile", "Int32", [
            MojoEnumValue("MAIN", 0),
            MojoEnumValue("HIGH", 1),
            MojoEnumValue("PROFESSIONAL", 2),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        MojoEnum("StdVideoAV1Level", "Int32", [
            MojoEnumValue("LEVEL_2_0", 0),
            MojoEnumValue("LEVEL_2_1", 1),
            MojoEnumValue("LEVEL_2_2", 2),
            MojoEnumValue("LEVEL_2_3", 3),
            MojoEnumValue("LEVEL_3_0", 4),
            MojoEnumValue("LEVEL_3_1", 5),
            MojoEnumValue("LEVEL_3_2", 6),
            MojoEnumValue("LEVEL_3_3", 7),
            MojoEnumValue("LEVEL_4_0", 8),
            MojoEnumValue("LEVEL_4_1", 9),
            MojoEnumValue("LEVEL_4_2", 10),
            MojoEnumValue("LEVEL_4_3", 11),
            MojoEnumValue("LEVEL_5_0", 12),
            MojoEnumValue("LEVEL_5_1", 13),
            MojoEnumValue("LEVEL_5_2", 14),
            MojoEnumValue("LEVEL_5_3", 15),
            MojoEnumValue("LEVEL_6_0", 16),
            MojoEnumValue("LEVEL_6_1", 17),
            MojoEnumValue("LEVEL_6_2", 18),
            MojoEnumValue("LEVEL_6_3", 19),
            MojoEnumValue("LEVEL_7_0", 20),
            MojoEnumValue("LEVEL_7_1", 21),
            MojoEnumValue("LEVEL_7_2", 22),
            MojoEnumValue("LEVEL_7_3", 23),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        ...
        # VP9
        MojoEnum("StdVideoVP9Profile", "Int32", [
            MojoEnumValue("PROFILE_0", 0),
            MojoEnumValue("PROFILE_1", 1),
            MojoEnumValue("PROFILE_2", 2),
            MojoEnumValue("PROFILE_3", 3),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
        MojoEnum("StdVideoVP9Level", "Int32", [
            MojoEnumValue("LEVEL_1_0", 0),
            MojoEnumValue("LEVEL_1_1", 1),
            MojoEnumValue("LEVEL_2_0", 2),
            MojoEnumValue("LEVEL_2_1", 3),
            MojoEnumValue("LEVEL_3_0", 4),
            MojoEnumValue("LEVEL_3_1", 5),
            MojoEnumValue("LEVEL_4_0", 6),
            MojoEnumValue("LEVEL_4_1", 7),
            MojoEnumValue("LEVEL_5_0", 8),
            MojoEnumValue("LEVEL_5_1", 9),
            MojoEnumValue("LEVEL_5_2", 10),
            MojoEnumValue("LEVEL_6_0", 11),
            MojoEnumValue("LEVEL_6_1", 12),
            MojoEnumValue("LEVEL_6_2", 13),
            MojoEnumValue("INVALID", 0x7FFFFFFF),
        ]),
...
def registry_command_to_mojo_methods(
    ...
    # Two-Call Pattern Detection (e.g. vkEnumerate...)
    if len(registry_command.params) < 2: 
        return methods
    count_param, data_param = registry_command.params[-2], registry_command.params[-1]
    ...
    # Emit Helper Method
    count_type = assert_type(MojoPointerType, count_type)
    count_pointee_type = assert_type(MojoBaseType, count_type.pointee_type)
    data_type = assert_type(MojoPointerType, data_type)
    is_result = registry_command.return_type == "VkResult"
    elem_type = data_type.pointee_type
    if isinstance(elem_type, MojoBaseType) and elem_type.name == "NoneType":
        elem_type = MojoBaseType("UInt8")

    list_type = f"List[{elem_type}]"
    ret_type_name = "ListResult" if is_result else "List"
    return_type = MojoBaseType(ret_type_name, [str(elem_type)])
